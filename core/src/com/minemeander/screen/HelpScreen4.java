 ...
 */
public class HelpScreen4 extends AbstractScreen{
    ...
    public HelpScreen4() {
        ...
        TextButton button2 = new TextButton("ENEMIES", skin);
        table.add(button2).pad(20);
        table.row();

        sectionImage = new Texture(Gdx.files.internal("material/UI/Enemy.jpg"));

        TextButton button6 = new TextButton("NEXT", skin);
        button6.addListener(new ChangeListener() {
            @Override
            public void changed (ChangeEvent event, Actor actor) {
                HelpScreen4.this.transitionTo(new HelpScreen5());
            }
        });
        ...
        button7.addListener(new ChangeListener() {
            @Override
            public void changed (ChangeEvent event, Actor actor) {
                HelpScreen4.this.transitionTo(new MainMenu());
            }
        });
