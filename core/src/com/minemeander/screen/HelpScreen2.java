 ...
 */
public class HelpScreen2 extends AbstractScreen{
    ...
    public HelpScreen2() {
        ...
        TextButton button2 = new TextButton("HUD", skin);
        table.add(button2).pad(20);
        table.row();

        sectionImage = new Texture(Gdx.files.internal("material/UI/Hud.jpg"));
