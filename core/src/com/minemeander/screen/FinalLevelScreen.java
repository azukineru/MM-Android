...
/**
 * Created by tex on 6/9/2016.
 */
public class FinalLevelScreen extends AbstractScreen{
    ...
    public FinalLevelScreen(int score){
        this.score = score;
        ...
        titleImage = new Texture(Gdx.files.internal("material/UI/FinalLevel.png"));
        ...
        button7.addListener(new ChangeListener() {
            ...
            public void changed (ChangeEvent event, Actor actor) {
                ...
                Art.winMusic.stop();
                FinalLevelScreen.this.transitionTo(new MainMenu());
            }
        });
